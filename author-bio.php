...
<div class="author-info
	...
	<div class="row">
		<div class="col-sm-12">
			<h2>
				<?php
					echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'ohme_technical_exam_author_bio_avatar_size', 48 ) ) . '&nbsp;';
					printf( esc_html__( 'About %s', 'ohme-technical-exam' ), get_the_author() );
				?>
			</h2>
			...
			<p class="author-links">
				...
				if ( ! empty( get_the_author_meta( 'user_url' ) ) ) {
					printf( '<a href="%s" class="www btn btn-secondary btn-sm">' . esc_html__( 'Website', 'ohme-technical-exam' ) . '</a>', esc_url( get_the_author_meta( 'user_url' ) ) );
				}
